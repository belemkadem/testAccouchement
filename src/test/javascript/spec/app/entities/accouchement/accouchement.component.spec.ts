...
import { AccouchementComponent } from 'app/entities/accouchement/accouchement.component';
...
describe('Component Tests', () => {
    describe('Accouchement Management Component', () => {
        let comp: AccouchementComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AccouchementComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.accouchements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
